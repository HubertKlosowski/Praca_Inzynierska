...
const subtitle = ref('Są to rekordy, dla których nie można jednoznacznie określić obecności depresji. ' +
    'Wartość prawdopodobieństwa depresji znajduję się w przedziale od 45% do 55% włącznie. ')
